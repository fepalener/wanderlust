...
void EffectBloom::apply(const sf::RenderTexture& input, sf::RenderTarget& output)
{
...
void EffectBloom::prepareTextures(sf::Vector2u size)
{
...
void EffectBloom::filterBright(const sf::RenderTexture& input, sf::RenderTexture& output)
{
...
void EffectBloom::blurMultipass(RenderTextureArray& renderTextures)
{
...
void EffectBloom::blur(const sf::RenderTexture& input, sf::RenderTexture& output, sf::Vector2f offsetFactor)
{
...
void EffectBloom::downsample(const sf::RenderTexture& input, sf::RenderTexture& output)
{
...
void EffectBloom::add(const sf::RenderTexture& source, const sf::RenderTexture& bloom, sf::RenderTarget& output)
{
